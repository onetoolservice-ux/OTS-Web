...
<div class="flex gap-6 mt-4">
    <button onClick={() => window.print()} class="text-blue-600 text-sm underline">Export PDF</button>
    <button onClick={exportCSV} class="text-blue-600 text-sm underline">Export CSV</button>
