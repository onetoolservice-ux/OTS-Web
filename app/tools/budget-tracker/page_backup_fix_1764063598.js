...
<div class="w-full flex flex-wrap justify-end gap-3 mb-4 mt-2">
  <Button onClick={() => window.print()} variant="primary"><IconDownload/> Export PDF</Button>
  <Button onClick={exportCSV} variant="outline"><IconDownload/> Export CSV</Button>
  <label class="cursor-pointer">
    <Button variant="outline"><IconUpload/> Import CSV</Button>
    <input type="file" accept=".csv" class="hidden" onChange={importCSV}/>
  </label>
</div>
...
<div class="w-full flex flex-wrap justify-end gap-3 mb-4 mt-2">
  <button onClick={() => window.print()} class="px-4 py-2 bg-blue-600 text-white text-sm rounded-lg shadow hover:bg-blue-700 transition">Export PDF</button>
  <button onClick={exportCSV} class="px-4 py-2 border border-blue-600 text-blue-600 text-sm rounded-lg shadow-sm hover:bg-blue-50 transition">Export CSV</button>
  <label class="px-4 py-2 border border-blue-600 text-blue-600 text-sm rounded-lg shadow-sm cursor-pointer hover:bg-blue-50 transition">
    Import CSV
    <input type="file" accept=".csv" class="hidden" onChange={importCSV} />
  </label>
</div>
